...
The simulator truncates when we reach 10000 time step, or it terminates when the 
...
Therefore,  ~ 1 million / 2048 = 488 total PPO updates. 
I do an evaluatation every 10 PPO updates, so 48 evaluations in total during the
course of training.
