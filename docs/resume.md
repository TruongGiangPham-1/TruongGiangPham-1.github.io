...
<p>{% include icon.html name="location" %} Edmonton, AB, CA &middot; Canadian Citizen</p>
...
[Github](https://github.com/TruongGiangPham-1/MARL)
- Testing MARL algorithms on Overcooked-AI.
- QMIX, IPPO, MAPPO, and Sarsa($$\lambda$$).

### Robotics in Duckietown
[Project Page]({{ '/412-projects/' | relative_url }}), [Github](https://github.com/NicolasOng/CMPUT503)
- PID-controlled wheeled robot in the real world.

### Parallel Sorting By Regular Sampling Implementation
[Github](https://github.com/TruongGiangPham-1/Parallel-sorting-by-regular-sampling-implementation)
